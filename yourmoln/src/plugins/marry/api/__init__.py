...
def marryNowTime() -> datetime.timedelta:
    """获取茉莉诞生至今时间的函数，有2个属性，days是天数，seconds是去掉天数后剩下的秒数"""
    return (datetime.datetime.now()-datetime.datetime.fromtimestamp(1513972500))
